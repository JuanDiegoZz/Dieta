...
import ingredientById from '../../api/ingredients/[id].js'
import mergeIngredients from '../../api/ingredients/[id]/merge.js'
...
describe('admin Node handlers', () => {
  ...
  it('updates ingredients through the atomic ingredient RPC', async () => {
    ...
    try {
      const output = mockResponse()
      await ingredientById(mockRequest({ method: 'PATCH', url: '/api/ingredients/22222222-2222-4222-8222-222222222222', body: { canonicalName: 'Pollo', aliases: ['ave'] } }), output.response)
  ...
  it('finalizes merge and permanent-delete responses through Node res', async () => {
    ...
    try {
      ...
      await mergeIngredients(mockRequest({ method: 'POST', url: '/api/ingredients/22222222-2222-4222-8222-222222222222/merge', body: { destinationId: '33333333-3333-4333-8333-333333333333' } }), mergeOutput.response)
